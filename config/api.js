...
exports['default'] = {
  general: function (api) {
    ...
    return {
      ...
      serverToken: 'Flieral-SiteBackend-Service',
      // The welcome message seen by TCP and webSocket clients upon connection
      welcomeMessage: 'Flieral Site Backend Service Project',
      // the redis prefix for actionhero's cache objects
      cachePrefix: 'FLAPI:SiteBackendService:Cache:',
      // the redis prefix for actionhero's cache/lock objects
      lockPrefix: 'FLAPI:SiteBackendService:Lock:',
